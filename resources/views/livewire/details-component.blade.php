                                    ...
                                    <div class="detail-info">
                                        ...
                                        <div class="detail-extralink">
                                            ...
                                            <div class="product-extra-link2">
                                                <button type="button" class="button button-add-to-cart" wire:click.prevent="store({{$product_id}}, '{{$product_name}}', {{$product_regular_price}})">Add to cart</button>
                                                ...
                                                <div class="product-img-action-wrap">
                                                    <div class="product-img product-img-zoom">
                                                        <a href="{{ route('product.details', ['slug'=> $rproduct->slug]) }}" tabindex="0">
                                                            ...
                                                            <img class="hover-img" src="{{ asset('assets/imgs/shop/product-') }}{{ $rproduct->id }}-2.jpg" alt="">
                                                        </a>
                                                    </div>

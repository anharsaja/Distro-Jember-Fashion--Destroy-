                ...
                <div class="row align-items-center">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <ul class="language-dropdown">
                                        ...
                                        <li><a href="#"><img src="assets/imgs/tkheme/flag-dt.png" alt="">Deutsch</a></li>
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="header-info header-info-right">
                            ...
                            <ul>
                                <li>
                                    <i class="fi-rs-user"></i>{{ Auth::user()->name }} / <form method="POST" action="{{ route('logout') }}">
                                        @csrf
            ...
            <div class="container">
                <div class="header-wrap header-space-between position-relative">
                    ...
                    <div class="hotline d-none d-lg-block">
                        <p><i class="fi-rs-smartphone"></i><span>Toll Free</span>+62 8570 6113 543</p>
                    </div>
